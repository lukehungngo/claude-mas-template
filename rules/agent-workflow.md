...
| 21 | Agent/skill names drift to bare or wrong prefix | Model simplifies `mas:engineer:engineer` → `engineer`, invents `mas:verification` | BAD/GOOD naming table in dev-loop/bug-fix checkpoint assertions + PreToolUse hook | In progress |
