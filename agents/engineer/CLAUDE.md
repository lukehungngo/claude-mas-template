...
- [ ] **Language diagnostics:** If `.claude/rules/language-stack.md` exists in the project, read it and run ALL commands listed under "Mandatory Diagnostic Commands". All must pass before writing the result. Log any failures under "Deviations" in your result.
